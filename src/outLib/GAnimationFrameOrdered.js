...
exports.GAnimationFrameOrdered = void 0;
const Env_1 = require("./Env");
const Utils_1 = require("./Utils");
const AbstractOrderedGenerator_1 = require("./AbstractOrderedGenerator");
class GAnimationFrameOrdered extends AbstractOrderedGenerator_1.AbstractOrderedGenerator {
    rafId = null;
    fps = 60;
    constructor() {
        super();
...
exports.GAnimationFrameOrdered = GAnimationFrameOrdered;
